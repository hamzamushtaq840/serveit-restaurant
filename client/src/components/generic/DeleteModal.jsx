...
import AlertErrorIcon from "../../assets/generic/AlertErrorIcon.png"
      ...
      <div className="flex min-h-screen items-center justify-center text-center sm:py-0">
        ...
        <div className="inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle">
          ...
          <div className="mb-3 justify-center bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            ...
            <button
              type="button"
              className="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 sm:ml-3 sm:mt-0 sm:w-auto sm:text-sm"
              onClick={onClose}>
              Cancel
            </button>
          </div>
