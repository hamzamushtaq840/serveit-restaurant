...
const CategoryItems = () => {
  return (
    <div className="mt-10 grid flex-1 grid-cols-4 gap-4">
      {[1, 2, 3, 4].map(v => (
        <div className="shadow-card group flex cursor-pointer flex-col items-center justify-center rounded-lg bg-[#ffffff] p-2 transition-all duration-300 hover:bg-primary/70 hover:text-white">
          <img
            src={menuItem}
            className="h-[61px] w-full rounded-md object-cover"
            alt="item"
          />
          <span className="mt-4">Fruits</span>
