...
// https://docs.google.com/document/d/1aWP5OqCMlY8ork4cn9vg3qpXMoJ7b-rQdif43LEm3sc/edit


// The task is to implement this form(with exact design) using Formik.

// -> Users can create or edit tax resources.

// If you can use the rest - hook package, it is better, but it is not mandatory.

// When you hit “Apply to x items” console.log this.




// “applied_to” can be “some” or “all”.


// When it is “all”, all items should be selected.


// Items might have categories.
// So put the category as a checkbox with a grey background.
// And put items with that category under the category checkbox.

// When the user clicks category checkbox or uncheck it, all items in that category should be checked or unchecked.

// And items without category should be grouped as well like in the design.

// The applicable_items is an array of item ids.
